...
const baseUrl = 'http://8.130.24.49/assets/'
export async function createSlides(){
  const slides = await Slide.find()
  if (!slides.length) {
    const slides: Pick<ISlideDocument, 'url'>[]= [
      { url: `${baseUrl}post_reactnative.png` },
      { url: `${baseUrl}post_react.png` },
      { url: `${baseUrl}post_vue.png` },
      { url: `${baseUrl}post_wechat.png` },
      { url: `${baseUrl}post_architect.jpg` }
    ]
    ...
    const courses: any[] = [
      {
        order: 1,
        title: "1.React全栈架构",
        video: `${baseUrl}vue.mp4`,
        poster: `${baseUrl}react_poster.jpg`,
        url: `${baseUrl}react_url.png`,
        price: "¥100.00元",
        category: "react",
      },
      {
      ...
      },
      {
        ...
        title: "6.Vue从入门到项目实战",
        video: `${baseUrl}vue.mp4`,
        poster: `${baseUrl}vue_poster.png`,
        url: `${baseUrl}vue_url.png`,
        price: "¥100.00元",
        category: "vue",
      },
      {
